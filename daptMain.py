...
if __name__ == "__main__":
    ...
    resp = requests.get(f"{CRAWL_LOG_URL}/DEPT_NOTICE", headers=headers)
    ...
    # 3️⃣ 목록 페이지 크롤링
    driver.get(f"{START_BASE_DEPT}&currPage=1")
    ...
    send_in_batches(payload_list, POST_ENDPOINT_DEPT, token)
